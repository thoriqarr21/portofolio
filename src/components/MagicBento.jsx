...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 bento-section"
    ref={gridRef}
    data-aos="fade-up"
...
const MagicBento = ({
  ...
  const source = Array.isArray(items) && items.length ? items : cardData;
