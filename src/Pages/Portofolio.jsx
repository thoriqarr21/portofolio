...
const techStacks = [
  ...
  { icon: "codeigniter-1.svg", language: "CodeIgniter" },
  { icon: "python.svg", language: "Python" },
  { icon: "laravel-3.svg", language: "Laravel" },
  { icon: "docker.svg", language: "Docker" },
  { icon: "expressjs.svg", language: "ExpressJS" },
  { icon: "firebase1.svg", language: "Firebase" },
  { icon: "postgresql_elephant.svg", language: "PostgreSql" },
...
export default function FullWidthTabs() {
  ...
  return (
    <div
      className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden lg:mb-12 mb-14"
      id="Portofolio"
    >
      ...
      >
        ...
        >
         ...
         Crafting high-quality digital experiences through thoughtful design, clean engineering, and modern technology.
          <Sparkles className="w-5 h-5 text-purple-400" />
        </p>
      </div>
